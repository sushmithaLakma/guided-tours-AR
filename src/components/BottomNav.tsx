...
import { Heart, House, ListMusic, Map as MapIcon, Compass, UtensilsCrossed } from "lucide-react";
...
export default function BottomNav() {
  ...
  const tabs = tour
    ...
    : [
        { key: "home", label: "Home", icon: House, path: "/" },
        { key: "map", label: "Map", icon: MapIcon, path: `/city/${cityId}/map` },
  ...
  return (
    <nav
      ...
      aria-label={tour ? "Tour navigation" : "Main navigation"}
    >
