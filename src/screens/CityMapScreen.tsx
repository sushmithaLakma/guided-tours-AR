    ...
    <div className="relative h-dvh flex flex-col bg-paper">
      ...
      {mode === "list" ? (
                  ...
                  {tour.stops.map((stop, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {visited && (
                          <span className="text-[9px] uppercase tracking-wide border border-ink-950 bg-ink-950 text-paper px-1.5 py-0.5 shrink-0">
                            Visited
                          </span>
                        )}
                      </button>
        ...
        <div className="flex-1 relative overflow-auto no-scrollbar bg-ink-50 touch-pan-x touch-pan-y">
          ...
          >
                ...
                return (
                  ...
                  >
                    <span className="relative">
                      ...
                      />
                      {stop.hasAR && (
                        <span className="absolute -top-1.5 -right-1.5 h-3 w-3 rounded-full bg-terracotta-500 border border-paper" />
                      )}
                    </span>
                    <span className="mt-1 max-w-[64px] truncate text-[8.5px] font-medium text-ink-800 bg-paper/85 px-1">
                      {stop.title}
                    </span>
                  </button>
                );
            ...
            {placeList.map((place) => {
              ...
              return (
                ...
                >
                  <span className="flex items-center justify-center h-6 w-6 bg-paper border border-ink-950">
          ...
          <div className="absolute left-3 bottom-3 bg-paper border border-ink-950 px-2.5 py-2 text-[10px] text-ink-600 flex flex-col gap-1">
            <span className="flex items-center gap-1.5">
